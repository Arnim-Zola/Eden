...
import IntelNetworkGraph from './IntelNetworkGraph'; // <-- Add this import
    ...
    <div style={{
      ...
      <div style={{ padding: "20px 24px 16px", borderBottom: "1px solid var(--border)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "4px" }}>
          <div style={{
            width: "6px", height: "6px", borderRadius: "50%", background: "#3ddc84",
          ...
          return (
            <button key={i} onClick={() => onSelectId(active ? null : i)}
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{
                  fontSize: "11px", color: active ? "var(--text)" : "var(--text-dim)",
              ...
              <div style={{
                width: "3px", minWidth: "3px", height: "40px", borderRadius: "2px",
    ...
    <div style={{ background: "var(--bg2)", border: "1px solid var(--border)", borderRadius: "4px", padding: "24px 28px", flex: 1, display: "flex", flexDirection: "column" }}>
      <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "16px" }}>
        <div style={{
          ...
          letterSpacing: "4px", color: "var(--text-dim)", textTransform: "uppercase"
...
function ClaimDrawer({ claim, index, onClose }) {
  ...
  return (
    <div style={{
      position: "fixed", inset: 0, zIndex: 100, background: "rgba(4,8,12,0.85)",
      ...
      <div onClick={(e) => e.stopPropagation()} style={{
        ...
        <div style={{ marginBottom: "24px" }}>
          ...
          <div style={{ height: "2px", background: "var(--border)", borderRadius: "1px" }}>
            <div style={{
              width: `${(claim.confidence_score ?? 0) * 100}%`, height: "100%", background: meta.color,
          ...
          <div>
            ...
            {claim.related_sources.map((src, i) => (
              <a key={i} href={src.url} target="_blank" rel="noreferrer"
                style={{
                  display: "block", marginBottom: "8px", padding: "12px 14px",
          ...
          <div style={{ marginBottom: "28px", paddingBottom: "20px", borderBottom: "1px solid var(--border)", display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
            <div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "16px", marginTop: "10px" }}>
                <span style={{
                  fontFamily: "var(--font-mono)", fontSize: "10px", color: threat.color,
